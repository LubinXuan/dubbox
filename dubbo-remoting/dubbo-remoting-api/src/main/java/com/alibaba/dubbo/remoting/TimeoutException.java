...
public class TimeoutException extends RemotingException {
    ...
    public TimeoutException(boolean serverSide, int timeout, Channel channel, String message) {
        super(channel, message);
        this.timeout = timeout;
        this.phase = serverSide ? SERVER_SIDE : CLIENT_SIDE;
    }

    public TimeoutException(boolean serverSide, int timeout, InetSocketAddress localAddress,
